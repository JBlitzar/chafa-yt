...
If I could make a really easy binary in Github releases or a `pipx` command, I would. Unfortunately, this project has a lot of _non-python external dependencies_. This makes packaging non-trivial. Binaries wouldn't be cross-platform. And installation instructions already exist for each of these. Anyways, the bootstrap script was as easy of a way as I could think of to make this work. You can read more about this in [here](real-installation-instructions.md)
